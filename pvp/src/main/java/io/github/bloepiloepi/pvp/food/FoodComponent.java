...
public class FoodComponent {
	...
	public static class Builder {
		...
		public Builder statusEffect(Potion effect, float chance) {
			this.statusEffects.add(Pair.of(effect, chance));
			return this;
		}
		
		public Builder turnsInto(Material turnsInto) {
			this.turnsInto = turnsInto;
			return this;
		}
		
		public Builder onEat(BiConsumer<Player, ItemStack> onEat) {
			this.onEat = onEat;
			return this;
		}
