...
/**
 * Called when an {@link CustomEntityProjectile} hits an entity or a block.
 * <br>
...
public abstract class ProjectileHitEvent implements EntityInstanceEvent {
	...
	/**
	 * Called when a {@link CustomEntityProjectile} hits a block.
	 * <br>
	...
	/**
	 * Called when a {@link CustomEntityProjectile} hits an entity.
