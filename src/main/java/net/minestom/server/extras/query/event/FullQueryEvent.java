...
public class FullQueryEvent extends QueryEvent<FullQueryResponse> {
     ...
     */
    public FullQueryEvent(ServerProcess serverProcess, @NotNull SocketAddress sender, int sessionID) {
        super(sender, sessionID, new FullQueryResponse(serverProcess));
    }
}
