...
public class BrewingStandInventory extends Inventory {
    ...
    public BrewingStandInventory(ServerProcess serverProcess, @NotNull Component title) {
        super(serverProcess, InventoryType.BREWING_STAND, title);
    }

    public BrewingStandInventory(ServerProcess serverProcess, @NotNull String title) {
        super(serverProcess, InventoryType.BREWING_STAND, title);
    }
