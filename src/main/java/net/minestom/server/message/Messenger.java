...
public final class Messenger {
     ...
     * @param uuid     the UUID of the sender, if any
     */
    public static void sendMessage(ServerSettingsProvider serverSettingsProvider, @NotNull Collection<Player> players, @NotNull Component message,
                                   @NotNull ChatPosition position, @Nullable UUID uuid) {
        PacketUtils.sendGroupedPacket(serverSettingsProvider, players, new SystemChatPacket(message, false),
