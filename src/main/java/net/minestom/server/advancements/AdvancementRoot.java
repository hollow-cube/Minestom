...
public class AdvancementRoot extends Advancement {
    public AdvancementRoot(ServerSettings serverSettings, @NotNull Component title, @NotNull Component description,
                           @NotNull ItemStack icon, @NotNull FrameType frameType,
                           float x, float y,
                           @Nullable String background) {
        super(serverSettings, title, description, icon, frameType, x, y);
