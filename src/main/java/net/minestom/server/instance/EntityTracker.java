...
public sealed interface EntityTracker extends ServerObject permits EntityTrackerImpl {
    static @NotNull EntityTracker newTracker(ServerProcess serverProcess) {
        return new EntityTrackerImpl(serverProcess);
    }
