...
public class InstanceContainer extends Instance {
    ...
    @Override
    public boolean breakBlock(@NotNull Player player, @NotNull Point blockPosition, @Nullable BlockFace blockFace) {
        final Chunk chunk = getChunkAt(blockPosition);
        ...
        if (allowed) {
            ...
            UNSAFE_setBlock(chunk, x, y, z, resultBlock, null,
                    new BlockHandler.PlayerDestroy(block, this, blockPosition, player, blockFace));
