...
public record Potion(@NotNull PotionEffect effect, byte amplifier,
    ...
    public void sendAddPacket(@NotNull Entity entity) {
        entity.sendPacketToViewersAndSelf(entity.getServerSettingsProvider(), new EntityEffectPacket(entity.getEntityId(), this, null));
    }
    ...
    public void sendRemovePacket(@NotNull Entity entity) {
        entity.sendPacketToViewersAndSelf(entity.getServerSettingsProvider(), new RemoveEntityEffectPacket(entity.getEntityId(), effect));
    }
