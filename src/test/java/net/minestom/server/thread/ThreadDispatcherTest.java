...
public class ThreadDispatcherTest {
    ...
    public void elementTick() {
        ...
        ThreadDispatcher<Object> dispatcher = ThreadDispatcher.singleThread(minecraftServer.getExceptionHandler());
        assertEquals(1, dispatcher.threads().size());
        assertThrows(Exception.class, () -> dispatcher.threads().add(new TickThread(minecraftServer.getExceptionHandler(),1)));
    ...
    public void partitionTick() {
        ...
        ThreadDispatcher<Tickable> dispatcher = ThreadDispatcher.singleThread(minecraftServer.getExceptionHandler());
        assertEquals(1, dispatcher.threads().size());
    ...
    public void uniqueThread() {
        ...
        ThreadDispatcher<Tickable> dispatcher = ThreadDispatcher.of(minecraftServer.getExceptionHandler(), ThreadProvider.counter(), threadCount);
    ...
    public void threadUpdate() {
        ...
        final int threadCount = 10;
        ThreadDispatcher<Updater> dispatcher = ThreadDispatcher.of(minecraftServer.getExceptionHandler(), new ThreadProvider<>() {
            @Override
