...
public class ArgumentTest {
    ...
    public void testParseSelf() {
        ...
        assertEquals("example", Argument.parse(new ServerSender(serverProcess), ArgumentType.String("example")));
        assertEquals(55, Argument.parse(new ServerSender(serverProcess), ArgumentType.Integer("55")));
    }
    ...
    public void testDefaultValue() {
        ...
        assertEquals("default value", arg.getDefaultValue().apply(new ServerSender(serverProcess)));
    }
    ...
    public void testSuggestionCallback() {
        ...
        arg.getSuggestionCallback().apply(new ServerSender(serverProcess), new CommandContext("input"), suggestion);
